...
const styles = StyleSheet.create({
    ...
    rangeSelector: { flexDirection: "row", gap: 6, marginVertical: 8 },
    chip: {
    ...
    statLabel: { fontSize: 11, fontWeight: "500", color: colors.textSecondary, textTransform: "uppercase" },
    statValue: { fontSize: 22, fontWeight: "800", color: colors.text, marginTop: 2 },
    trendPill: { flexDirection: "row", alignItems: "center", gap: 2, borderRadius: 4, paddingHorizontal: 5, paddingVertical: 2, marginTop: 2 },
    trendPillText: { fontSize: 10, fontWeight: "700" },
    sectionHeader: { marginTop: 12, marginBottom: 6, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
    ...
    iconBox: { width: 32, height: 32, borderRadius: 16, alignItems: "center", justifyContent: "center", marginRight: 8 },
    itemLabel: { flex: 1, fontSize: 14, fontWeight: "600", color: colors.text },
    ...
    productRankText: { fontSize: 10, fontWeight: "800", color: colors.primary },
    productInfo: { flex: 1 },
    productName: { fontSize: 14, fontWeight: "600", color: colors.text },
    productSales: { fontSize: 11, color: colors.textSecondary, marginTop: 1 },
    productAmount: { fontSize: 14, fontWeight: "700", color: colors.text },
    emptyProducts: { alignItems: "center", paddingVertical: 16, gap: 4 },
    emptyProductsText: { fontSize: 13, color: colors.textSecondary },
    viewAll: { fontSize: 12, fontWeight: "700", color: colors.primary },
    emptyTransactions: { alignItems: "center", paddingVertical: 16, gap: 6, backgroundColor: colors.surface, borderRadius: 10, borderWidth: 1, borderColor: colors.border },
    emptyTransactionsText: { fontSize: 13, color: colors.textSecondary },
    transactionRow: {
        flexDirection: "row",
        alignItems: "center",
        paddingHorizontal: 8,
    ...
    txIcon: { width: 32, height: 32, borderRadius: 16, alignItems: "center", justifyContent: "center", marginRight: 8 },
    txInfo: { flex: 1 },
    txName: { fontSize: 14, fontWeight: "700", color: colors.text },
    txMeta: { fontSize: 11, color: colors.textSecondary, marginTop: 1 },
